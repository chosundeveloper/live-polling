...
- 주요 상수: `INTRO_GROWTH_RATE`, `INTRO_HOLD_PROGRESS`, `INTRO_HOLD_TRAVEL_RATIO`, `INTRO_BLOOM_JITTER`, `OUTWARD_DRIFT_FORCE`, `TARGET_ATTRACTION_FORCE`, `RADIAL_FORCE`, `MAX_PARTICLE_SPEED`, `MIN_SEPARATION`.
